...
var author$project$Main$ChecklistItem = F2(
...
var author$project$Main$mchecklist = F2(
	function (title, items) {
		return A2(
			...
			A2(
				elm$core$List$map,
				author$project$Main$ChecklistItem(false),
				items));
	});
...
var author$project$Main$myChecklists = elm$core$Array$fromList(
	_List_fromArray(
		[
			A2(
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{checklists: author$project$Main$myChecklists, currentChecklist: elm$core$Maybe$Nothing},
...
var author$project$Main$toggleItem = F2(
	function (itemid, model) {
		var _n0 = model.currentChecklist;
		if (_n0.$ === 'Nothing') {
			return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
		} else {
			var cid = _n0.a;
			var _n1 = A2(elm$core$Array$get, cid, model.checklists);
			if (_n1.$ === 'Nothing') {
				return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			} else {
				var cl = _n1.a;
				var items = A2(
					...
					F2(
						function (i, item) {
							return _Utils_eq(i, itemid) ? _Utils_update(
								item,
								{checked: !item.checked}) : item;
						}),
					cl.items);
				var updatedCl = _Utils_update(
					cl,
					{items: items});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							checklists: A3(elm$core$Array$set, cid, updatedCl, model.checklists)
						}),
					elm$core$Platform$Cmd$none);
			}
		}
...
var author$project$Main$viewChecklistItem = F2(
	function (id, item) {
		return A2(
			elm$html$Html$li,
			_List_fromArray(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('tc ph4')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('f3 f2-m f1-l fw2 black-90 mv3')
							]),
						_List_fromArray(
							[
								elm$html$Html$text(checklist.title)
							]))
					])),
				A2(
...
var author$project$Main$viewChecklistMenu = function (checklists) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				A2(
					elm$core$List$map,
					author$project$Main$viewChecklistLink,
					elm$core$Array$toIndexedList(checklists)))
			]));
};
var author$project$Main$view = function (m) {
	var _n0 = m.currentChecklist;
	if (_n0.$ === 'Nothing') {
		return author$project$Main$viewChecklistMenu(m.checklists);
	} else {
		var i = _n0.a;
		var _n1 = A2(elm$core$Array$get, i, m.checklists);
		if (_n1.$ === 'Nothing') {
			return A2(elm$html$Html$div, _List_Nil, _List_Nil);
		} else {
			var checklist = _n1.a;
			return author$project$Main$viewChecklist(checklist);
		}
	}
};
